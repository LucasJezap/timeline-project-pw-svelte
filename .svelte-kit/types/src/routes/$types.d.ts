...
type LayoutRouteId = RouteId | "/" | "/category/[id]" | "/event/[id]" | "/profile/[id]" | "/settings/[id]" | "/tables/categories" | "/tables/timeline-events" | "/tables/timeline-events-categories" | "/tables/user-settings" | "/tables/users" | null
